...
/**
 * Garante uma sessão Supabase. Restaura do localStorage; se não houver,
 * faz signInAnonymously() pra criar um user temporário.
 */
...
/**
 * Wrapper fetch com Bearer token + JSON helpers.
 */
